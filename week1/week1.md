...
<ul>
  ...
  <li> /: дели стойностите на две променливи (или литерали). Връща стойност (rvalue). Обърнете внимание, че този оператор действа различно в зависимост от типа на данните - ако всички данни са цели числа, то операторът ще произведе цяло число. Но ако поне една от данните е число с плаваща запетая, то операторът ще произведе число с плаваща запетая. Например: 14/3 ще даде 4 (14/3 = 4 и остатък 2), но 14.0 / 3 = 4.667. </li>
...
<details>
  <summary>Помощ</summary>
  Използвайте sqrt(функция за изчисляване на квадратен корен) от библиотеката cmath.
</details>
...
<details>
  <summary>Помощ</summary>
  Използвайте abs(функция за изчисляване на абсолютна стойност) от библиотеката cmath.
</details>
